...
class FollowUseCase {
    ...
    fun updateFollower(
        ...
        if (flag) {
            ...
            followerStatusUpdate(targetFeed.email, myEmail, "follower", myFollow, db, true)
            followerStatusUpdate(myEmail, targetFeed.email, "following", targetFollow, db, true)
        } else {
            followerNumberUpdate(targetFeed.email, "follower", db, false)
            followerNumberUpdate(myEmail, "following", db, false)

            followerStatusUpdate(targetFeed.email, myEmail, "follower", myFollow, db, false)
            followerStatusUpdate(myEmail, targetFeed.email, "following", targetFollow, db, false)
        }
    }
